...
public class DiagnosisController implements Create<DiagnosisDto> {
	...
	@PostMapping
	@Override
	public ResponseEntity<Response<DiagnosisDto>> create(@Valid @RequestBody DiagnosisDto objectDto, BindingResult bindingResult)
			throws NoSuchAlgorithmException {
		LOGGER.info("Recebendo Diagnostico: {}", objectDto.toString());
		Response<DiagnosisDto> response = new Response<DiagnosisDto>();
		Diagnosis diagnosis = diagnosisFactory.getObject(objectDto);
